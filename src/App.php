 ...
 *  -    all
 */
namespace Difference\Fun;

use Difference\Fun\Exception\RouteNotExistException;
use Difference\Fun\Module\SharedMemory;
use stdClass;

use Difference\Fun\Module\Autoload;
use Difference\Fun\Module\Cache;
...
//                        ob_get_clean();
    ...
    public function parse_select($url, $select=null, $scope='scope:object'): Data
    {
        ...
        $parse->storage()->data('difference.fun.parse.view.url', $url);
